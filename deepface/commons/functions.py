...
def detect_face(img, detector_backend = 'opencv', grayscale = False, enforce_detection = True, align = True):
	...
	#img_path = "F:\\All Results\\Makale\\Dataset\\skip_check\\test.jpg"
	#----------------------------------------------
	...
	try:
		...
		"""detected_face = cv2.resize(detected_face, dsize=(94, 125))"""

		#cv2.namedWindow("window", cv2.WINDOW_NORMAL)
		#cv2.resizeWindow("window", 500,500)
		cv2.imshow("window",detected_face)
		cv2.waitKey(0)
